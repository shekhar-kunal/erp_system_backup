...
SECRET_KEY = 'django-insecure-yl+$q2f-$jc@1l6()@a!x1w7-^8a35_#^__s1r%fl5i&*oxa=l'
...
MIDDLEWARE = [
    ...
    'rbac.middleware.ERPSecurityMiddleware',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'config_settings.context_processors.currencies',
                'config_settings.context_processors.erp_settings',
            ],
        },
    },
]
